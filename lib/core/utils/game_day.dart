...
class GameDay {
  ...
  /// ortasında kesmiyor, serisini haksız yere kırmıyor. Değiştirmek için
  /// yalnızca bu sabit güncellenir; adım sıfırlaması, çark hakkı, çark geri
  /// sayımı ve seri otomatik uyar.
